...
public class ParentescoOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public String getLastUpdateKey(){
        return "parentescos_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseParentesco(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetParentescosRequest(listener,errorListener);
    }
