...
public class HGetNationalitiesRequest extends HRequest<ArrayList<QuoteOption>> {

    private static final String PATH = RestConstants.HOST + RestConstants.GET_MODULO_BASE;

    public HGetNationalitiesRequest(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener) {
        super(Method.GET, PATH , listener, errorListener);
    }

    @Override
    protected ArrayList<QuoteOption> parseObject(Object obj) {
        return ParserUtils.parseNationalities((JSONObject) obj);
    }
