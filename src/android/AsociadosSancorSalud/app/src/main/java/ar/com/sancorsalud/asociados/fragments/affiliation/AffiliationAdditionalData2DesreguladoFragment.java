...
import ar.com.sancorsalud.asociados.model.affiliation.AdditionalData2Desregulado;
...
public class AffiliationAdditionalData2DesreguladoFragment extends BaseFragment implements IAffiliationAdditionalData2Fragment {

    private static final String TAG = "DESRG2_FRG";
    ...
    private AdditionalData2Desregulado additionalData2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            additionalData2 = (AdditionalData2Desregulado) getArguments().getSerializable(ARG_ADD_DATA_2);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == ConstantsUtil.VIEW_CONYUGE_OS) {
            ...
            if (conyugeData != null &&  hasToUpdateConyugeMonoFiles) {
                Log.e(TAG, "onActivityResult updating conyufe mono files... ");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainContainer = inflater.inflate(R.layout.fragment_affiliation_additional_data_desreg2, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        attachFilesSubDir = titularDNI + "/affiliation/osActual";
        ...
        if (obraSocial != null) {
            ...
            osType = obraSocial.osQuotation.extra;
            if (osType != null) {
                Log.e(TAG, "OS: type: " + osType + " *******************");
    ...
    public IAdditionalData2 getAdditionalData2() {
        ...
        obraSocial.personCardId = titularCardId;
    ...
    private void fillComprobantesSSSFiles() {
        ...
        if (!additionalData2.obraSocial.comprobantesSSSFiles.isEmpty()) {

            Log.e(TAG, "fillComprobantesSSSFiles !!....");

            final AttachFile sssFile = additionalData2.obraSocial.comprobantesSSSFiles.remove(0);
            ...
            additionalData2.obraSocial.comprobantesSSSFiles.addAll(tmpSSSFiles);
    ...
    private void fillAfipFiles() {
        ...
        if (!additionalData2.obraSocial.comprobantesAfipFiles.isEmpty()) {

            Log.e(TAG, "fillAfipFiles !!....");

            final AttachFile afipFile = additionalData2.obraSocial.comprobantesAfipFiles.remove(0);
            ...
            additionalData2.obraSocial.comprobantesAfipFiles.addAll(tmpAfipFiles);
    ...
    private void fillEmailFiles() {
        ...
        if (!additionalData2.obraSocial.emailFiles.isEmpty()) {

            Log.e(TAG, "emailFiles !!....");

            final AttachFile emailFile = additionalData2.obraSocial.emailFiles.remove(0);
            ...
            additionalData2.obraSocial.emailFiles.addAll(tmpEmailFiles);
    ...
    private void fillForm53Files() {
        ...
        if (!additionalData2.obraSocial.form53Files.isEmpty()) {

            Log.e(TAG, "form53Files !!....");

            final AttachFile form53File = additionalData2.obraSocial.form53Files.remove(0);
            if (form53File.fileNameAndExtension == null || form53File.fileNameAndExtension.isEmpty()) {
                ...
                CardController.getInstance().getFile(getActivity().getApplicationContext(), attachFilesSubDir + "/" + FORM_53_FILE_PREFIX, form53File.id, new Response.Listener<AttachFile>() {
                    ...
                    public void onResponse(AttachFile resultFile) {
                        ...
                        if (resultFile != null) {
                            Log.e(TAG, "ok getting form53 File !!!!");
                            Log.e(TAG, "nameAndExtendion:  " + resultFile.fileNameAndExtension);
                            Log.e(TAG, "path:  " + resultFile.filePath);
            ...
            additionalData2.obraSocial.form53Files.addAll(tmpForm53Files);
    ...
    private void fillForm59Files() {
        ...
        if (!additionalData2.obraSocial.form59Files.isEmpty()) {

            Log.e(TAG, "form59Files !!....");

            final AttachFile form59File = additionalData2.obraSocial.form59Files.remove(0);
            ...
            additionalData2.obraSocial.form59Files.addAll(tmpForm59Files);
    ...
    private void fillModelNotesFiles() {
        ...
        if (!additionalData2.obraSocial.modelNotesFiles.isEmpty()) {

            Log.e(TAG, "fillModelNotesFiles !!....");

            final AttachFile noteFile = additionalData2.obraSocial.modelNotesFiles.remove(0);
            if (noteFile.fileNameAndExtension == null || noteFile.fileNameAndExtension.isEmpty()) {
                ...
                CardController.getInstance().getFile(getActivity().getApplicationContext(), attachFilesSubDir + "/" + MODEL_NOTE_FILE_PREFIX, noteFile.id, new Response.Listener<AttachFile>() {
                    ...
                    public void onResponse(AttachFile resultFile) {
                        ...
                        if (resultFile != null) {
                            Log.e(TAG, "ok getting ModelNote File !!!!");
                            Log.e(TAG, "nameAndExtendion:  " + resultFile.fileNameAndExtension);
                            Log.e(TAG, "path:  " + resultFile.filePath);
            ...
            additionalData2.obraSocial.modelNotesFiles.addAll(tmpModelNotesFiles);
        ...
        if (osType.equals(ConstantsUtil.OS_TYPE_SINDICAL)) {
            ...
            if (osState != null && (osState.id.equals(ConstantsUtil.OS_STATE_ACTIVE_AT_INTPUT))) {
                ...
                if (osState != null && (osState.id.equals(ConstantsUtil.OS_STATE_OTHER_OS_OPTION))) {
                    DialogHelper.showMessage(getActivity(), getResources().getString(R.string.help_os_other_option));
                }
            ...
            if (osState != null && (osState.id.equals(ConstantsUtil.OS_STATE_ACTIVE))) {
                ...
                mOSActualBox.setVisibility(View.GONE);
                String osId = additionalData2.obraSocial.osQuotation.id;
    ...
    private void checkShowFieldsForActualOS(QuoteOption oSActual, QuoteOption osState, boolean cleanData) {
        ...
        if (oSActual.id.equals(osId)) {
            ...
            if (oSActual.extra.equals(ConstantsUtil.OS_TYPE_SINDICAL)) {
                ...
                // FOR OS OSIM and ASE DESREGULARA
                mForm53Box.setVisibility(View.VISIBLE);
                mModelNoteBox.setVisibility(View.VISIBLE);
            } else {
                // DIRECCION
    ...
    private void initializeForm() {
        ...
        checkShowOSFields(additionalData2.obraSocial.osState, false);
    ...
    private void initOSBaseForm() {
        ...
        if (obraSocial != null) {
            ...
            if (obraSocial.mesesImpagos != -1) {
                if (obraSocial.mesesImpagos == 0) {
                    ...
                    mMesesImpagosEditText.setText(Integer.valueOf(obraSocial.mesesImpagos).toString());
                    mDayAportesRadioButton.setChecked(false);
                    mMonthAportesRadioButton.setChecked(true);


                    if (editableCard && obraSocial.mesesImpagos > 2) {
            ...
            if (osType != null && osType.equals(ConstantsUtil.OS_TYPE_DIRECCION) && obraSocial.osActual != null) {
                mSelectedActualOS = mObrasSociales.indexOf(obraSocial.osActual);
                if (mSelectedActualOS != -1) {
                    mOSActualEditText.setText(obraSocial.osActual.title);
                }
            }
        }
    }
    ...
    private void initComprobanteSSSFiles() {
        ...
        mSSSFileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.comprobantesSSSFiles, true);
    ...
    private void initComprobantesAfipFiles() {
        ...
        mAfipFileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.comprobantesAfipFiles, true);
    ...
    private void initEmailFiles() {
        ...
        mEmailFileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.emailFiles, true);
    ...
    private void initForm53Files() {
        ...
        mForm53FileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.form53Files, true);
    ...
    private void initFomr59Files() {
        ...
        mForm59FileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.form59Files, true);
    ...
    private void initModelNoteFiles() {
        ...
        mModelNoteFileAdapter = new AttachFilesAdapter(additionalData2.obraSocial.modelNotesFiles, true);
        ...
        if (editableCard) {
            ...
            mSSSFileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View v, int position) {
                    ...
                    attachFileType = COMPROBANTE_SSS_FILE_PREFIX;
                    AttachFile sssFile = additionalData2.obraSocial.comprobantesSSSFiles.get(position);
                    if (sssFile.id != -1) {
            ...
            mAfipFileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View v, int position) {
                    ...
                    attachFileType = AFIP_FILE_PREFIX;
                    AttachFile afipFile = additionalData2.obraSocial.comprobantesAfipFiles.get(position);
                    if (afipFile.id != -1) {
            ...
            if (osType.equals(ConstantsUtil.OS_TYPE_SINDICAL)) {
                ...
                mEmailFileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        attachFileType = EMAIL_FILE_PREFIX;
                        AttachFile emailFile = additionalData2.obraSocial.emailFiles.get(position);
                        if (emailFile.id != -1) {
                ...
                mForm53FileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        attachFileType = FORM_53_FILE_PREFIX;
                        AttachFile form53File = additionalData2.obraSocial.form53Files.get(position);
                        if (form53File.id != -1) {
                ...
                mForm59FileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        Log.e(TAG, "form53File onItemDeleteClick()!!!!!:" + position);
                        attachFileType = FORM_59_FILE_PREFIX;
                        AttachFile form59File = additionalData2.obraSocial.form59Files.get(position);
                        if (form59File.id != -1) {
                ...
                mModelNoteFileAdapter.setOnItemDeleteClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        attachFileType = MODEL_NOTE_FILE_PREFIX;
                        AttachFile noteFile = additionalData2.obraSocial.modelNotesFiles.get(position);
                        if (noteFile.id != -1) {
    ...
    private void showOsDesregAlert() {
        ...
        ArrayList<String> osDesrgStr = new ArrayList<String>();
        for (QuoteOption q : mObrasSociales) {
            osDesrgStr.add(q.optionName());
        }

        mOSActualAlertAdapter = new SpinnerDropDownAdapter(getActivity(), osDesrgStr, mSelectedActualOS);
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
