...
public class QuoteActivity extends BaseActivity implements QuoteListener {

    private static final String TAG = "QUOTE_ACT";
    ...
    private void setupListeners() {
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ConstantsUtil.Segmento segmento = null;
                ...
                if (mCurrentPage == 0) {  // P1 Basic Data
                    ...
                    segmento = mQuotation == null ? null : mQuotation.getSegmento();
                    if (segmento == null) {
                        return;
                    } else if (segmento == ConstantsUtil.Segmento.DESREGULADO) { // P4 Aportes desregulados
                    ...
                    } else if (segmento == ConstantsUtil.Segmento.MONOTRIBUTO) {   // P4 Datos Monotributo
        ...
        mBaseFragment.updateEmpresa(new Response.Listener<QuoteOption>() {
            ...
            public void onResponse(QuoteOption response) {
                ...
                if (response == null || response.id == null) {
                    ...
                    new AlertDialog.Builder(QuoteActivity.this).setMessage(getString(R.string.quote_incorrect_empresa)).setPositiveButton(R.string.option_ok, new DialogInterface.OnClickListener() {
                        @Override
        ...
        mBaseFragment.updateAfinidad(new Response.Listener<QuoteOption>() {
            ...
            public void onResponse(QuoteOption response) {
                ...
                if (response == null || response.id == null) {
                    ...
                    new AlertDialog.Builder(QuoteActivity.this).setMessage(getString(R.string.quote_incorrect_afinidad)).setPositiveButton(R.string.option_ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                        }
    ...
    private void highlightDot(ImageView dot) {
        mDopPage1.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorDarkGrey));
        mDopPage2.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorDarkGrey));
        mDopPage3.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorDarkGrey));
        mDopPage4.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorDarkGrey));
        mDopPage5.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorDarkGrey));

        dot.setColorFilter(ContextCompat.getColor(QuoteActivity.this, R.color.colorAccent));
    }
        ...
        if (AppController.getInstance().isNetworkAvailable()) {
            ...
            QuotationController.getInstance().quoteData(quotation, new Response.Listener<QuotationDataResult>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    dismissProgressDialog();
                    Log.e(TAG, "Error en la cotizacion:" + ((error != null && error.getMessage() != null) ? error.getMessage() : ""));
                    DialogHelper.showMessage(QuoteActivity.this, getResources().getString(R.string.error_quote), ((error != null && error.getMessage() != null) ? error.getMessage() : ""));
                }
            });
        } else {
            DialogHelper.showNoInternetErrorMessage(QuoteActivity.this, null);
        }
    }
    ...
    private void toQuotationResult(QuotationDataResult quotationResult) {
        ...
        IntentHelper.goToQuotationResultActivity(QuoteActivity.this, quotationResult);
    }


    private void toAdditionalesOptativosForPA(Quotation quotation, AdicionalesOptativosData optativosData) {
        IntentHelper.goToAdicionalesOptativosActivity(QuoteActivity.this, quotation, optativosData);
    }
