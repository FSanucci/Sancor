...
public class HGetNoGravRequest extends HRequest<HashMap<String,Station>> {

    private static final String TAG = "GET_NOGRAV";
    private static final String PATH = RestConstants.HOST + RestConstants.GET_NOGRAV;
    private long mProspectiveClienteId;

    public HGetNoGravRequest(long paId, Response.Listener<HashMap<String,Station>> listener, Response.ErrorListener errorListener) {
