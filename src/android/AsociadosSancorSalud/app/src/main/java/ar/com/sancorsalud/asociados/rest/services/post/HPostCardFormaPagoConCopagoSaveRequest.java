...
public class HPostCardFormaPagoConCopagoSaveRequest extends HRequest<Pago> {
    ...
    public HPostCardFormaPagoConCopagoSaveRequest(Pago pago, Response.Listener<Pago> listener, Response.ErrorListener errorListener) {
