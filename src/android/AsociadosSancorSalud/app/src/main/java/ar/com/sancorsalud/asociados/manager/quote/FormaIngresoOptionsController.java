...
public class FormaIngresoOptionsController extends BaseQuoteOptionsController<QuoteOption> {

    public String getObjectKey(){
        return "forma_de_ingresos";
    }

    public String getLastUpdateKey(){
        return "forma_de_ingresos_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseFormasIngreso(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetFormasIngresoRequest(listener,errorListener);
    }
