...
public class AccountTypeOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public String getLastUpdateKey(){
        return "accountType_last_update";
    }

    public String getLocalJsonName(){
        return "tipo_cuenta.json";
    }

    public ArrayList<QuoteOption> parseData(String json){
        try {
            JSONObject jsonObj = new JSONObject(json);
            return ParserUtils.parseAccountTypes(jsonObj);
