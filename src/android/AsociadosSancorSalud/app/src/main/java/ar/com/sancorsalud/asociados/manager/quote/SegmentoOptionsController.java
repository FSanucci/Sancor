...
public class SegmentoOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseSegmentos(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetSegmentosRequest(listener,errorListener);
    }
