...
public class CondicionIvaOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public String getLastUpdateKey(){
        return "condiciones_iva_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseCondicionIva(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetCondicionIvaRequest(listener,errorListener);
    }
