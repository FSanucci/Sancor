...
/**
 * Created by sergiocirasa on 26/9/17.
 */

public class HGetProspectiveClientsByStateRequest extends HRequest<ArrayList<ProspectiveClient>> {

    //private static final String PATH = RestConstants.HOST + RestConstants.GET_ALL_PROSPECTIVE_CLIENT_BY_STATE;
    private static final String PATH = RestConstants.HOST + RestConstants.GET_PAGING_PA_LIST + "?size=1000&page=1&filtroEstadoFicha=";

    public HGetProspectiveClientsByStateRequest(ProspectiveClient.State state, Response.Listener<ArrayList<ProspectiveClient>> listener, Response.ErrorListener errorListener) {
        super(Request.Method.GET, PATH + state.getValue(), listener, errorListener);
    }
