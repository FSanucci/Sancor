...
public class TarjetaOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseTarjetas(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetTarjetasRequest(listener,errorListener);
    }
