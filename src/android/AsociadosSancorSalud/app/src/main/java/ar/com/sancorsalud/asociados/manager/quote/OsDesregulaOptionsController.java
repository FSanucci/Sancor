...
public class OsDesregulaOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public String getLastUpdateKey(){
        return "os_desregula_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseOSDesregula(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetOSDesregulaRequest(listener,errorListener);
    }
