...
public class SubteGravActivity extends SubteActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subte_grav);
    ...
    public HRequest createService(Response.Listener<HashMap<String,Station>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetGravRequest(mProspectiveClientId,listener,errorListener);
    }
