...
public class HPostGetFileRequest extends HRequest<DecodedFile> {

    private static final String TAG = "HPOST_GET_FILE";
    private static final String PATH = RestConstants.HOST + RestConstants.POST_GET_FILE;

    private long resourceId;

    public HPostGetFileRequest(long resourceId, Response.Listener<DecodedFile> listener, Response.ErrorListener errorListener) {
