...
public class HPostQuotationParametersForQuotedClientRequest extends HRequest<Quotation> {

    private static final String TAG = "HQUOTED_PARAMS";
    private static final String PATH = RestConstants.HOST + RestConstants.POST_LISTAR_COTIZADOS;

    private boolean fillCotizaciones = false;
    private long dni;
    private String filter;

    /*
    public HPostQuotationParametersForQuotedClientRequest(long dni, Response.Listener<Quotation> listener, Response.ErrorListener errorListener) {
        super(Method.POST, PATH, listener, errorListener);
        this.dni = dni;
    }
    */

    public HPostQuotationParametersForQuotedClientRequest(long dni, boolean fillCotizaciones , Response.Listener<Quotation> listener, Response.ErrorListener errorListener) {
        super(Method.POST, PATH, listener, errorListener);
        this.dni = dni;
        this.fillCotizaciones = fillCotizaciones;
    }

    public HPostQuotationParametersForQuotedClientRequest(long dni, boolean fillCotizaciones , String filter, Response.Listener<Quotation> listener, Response.ErrorListener errorListener) {
        super(Method.POST, PATH, listener, errorListener);
        this.dni = dni;
        this.fillCotizaciones = fillCotizaciones;
        this.filter = filter;
    ...
    protected Quotation parseObject(Object obj) {
        ...
        if (obj instanceof JSONObject) {
            ...
            Log.e(TAG, "QUOT RESP: " + dic.toString());
            ...
            if (dic != null) {
                try {
                                ...
                                if (jCotizacion != null) {
                                    ...
                                    if (jCapitasArray != null) {
                                        ...
                                        for (int l = 0; l < jCapitasArray.length(); l++) {
                                            ...
                                            m.loadFromQR = jMember.optBoolean("cargado_por_qr", false);
                    ...
                    if (jParams != null) {
                        ...
                        String titleAfinidad = ParserUtils.optString(jParams, "descripcion_afinidad") != null ? ParserUtils.optString(jParams, "descripcion_afinidad") : null;
                        quotation.nombreAfinidad = new QuoteOption(ParserUtils.optString(jParams, "afinidad_id") != null ? ParserUtils.optString(jParams, "afinidad_id").trim() : null, titleAfinidad);
                        ...
                        String titleEmpresa = ParserUtils.optString(jParams, "descripcion_empresa") != null ? ParserUtils.optString(jParams, "descripcion_empresa") : null;
                        quotation.nombreEmpresa = new QuoteOption(ParserUtils.optString(jParams, "empresa_id") != null ? ParserUtils.optString(jParams, "empresa_id").trim() : null, titleEmpresa);
