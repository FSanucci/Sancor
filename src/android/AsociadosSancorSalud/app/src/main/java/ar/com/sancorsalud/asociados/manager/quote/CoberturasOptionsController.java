...
public class CoberturasOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseCoberturas(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetCoberturasRequest(listener,errorListener);
    }
