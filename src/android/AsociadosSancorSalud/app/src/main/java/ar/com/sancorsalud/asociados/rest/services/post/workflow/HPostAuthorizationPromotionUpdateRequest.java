...
public class HPostAuthorizationPromotionUpdateRequest extends HRequest<Void> {

    private static final String TAG = "HPOST_UPDATE_AUTH_PROM";
    private static final String PATH = RestConstants.HOST + RestConstants.UPDATE_AUTHORIZATION_PROMOTION;

    private AuthorizationPromotion mAuthorization;


    public HPostAuthorizationPromotionUpdateRequest(AuthorizationPromotion authorization, Response.Listener<Void> listener, Response.ErrorListener errorListener) {
