...
public class AffiliationAdditionalData1DesreguladoEmpresaFragment extends AffiliationAdditionalData1FormaPagoEmpresaFragment {

    private static final String TAG = "AF_DESR_EMP1_FRG";
    ...
    public static AffiliationAdditionalData1DesreguladoEmpresaFragment newInstance(AdditionalData1DesreguladoEmpresa param1, long dni, long cardId, String cuil, QuoteOption empresa, String fechaInicioServicio) {
        AffiliationAdditionalData1DesreguladoEmpresaFragment fragment = new AffiliationAdditionalData1DesreguladoEmpresaFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            additionalData1 = (AdditionalData1DesreguladoEmpresa) getArguments().getSerializable(ARG_ADD_DATA_1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainContainer = inflater.inflate(R.layout.fragment_affiliation_additional_data_desreg_emp1, container, false);
    ...
    public IAdditionalData1 getAdditionalData1() {
        ...
        AdditionalData1DesreguladoEmpresa additionalData = (AdditionalData1DesreguladoEmpresa) super.getAdditionalData1();
    ...
    protected void initializeForm() {
        ...
        AdditionalData1DesreguladoEmpresa additionalData = (AdditionalData1DesreguladoEmpresa)additionalData1;
    ...
    protected void setupListeners() {
        ...
        mEEAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                ...
                IntentHelper.gotoEntidadEmpleadoraActivity(AffiliationAdditionalData1DesreguladoEmpresaFragment.this, titularDNI, position, ee);
            }
        });
