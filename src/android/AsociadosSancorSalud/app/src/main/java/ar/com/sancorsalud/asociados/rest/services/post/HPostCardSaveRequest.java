...
public class HPostCardSaveRequest extends HRequest<AffiliationDataResult> {

    private static final String TAG = "HPOST_SAVECARD";
    private static final String PATH = RestConstants.HOST + RestConstants.POST_CARD_SAVE;

    private AffiliationCard affiliationCard;

    public HPostCardSaveRequest(AffiliationCard affiliationCard, Response.Listener<AffiliationDataResult> listener, Response.ErrorListener errorListener) {
    ...
    public byte[] getBody() {
        ...
        try {
            ...
            if (user != null) {
                json.put("promotor_id", user.id);
            } else {
                json.put("promotor_id", JSONObject.NULL);
            }

            json.put("grupo_afinidad_id", (affiliationCard.titularData != null && affiliationCard.titularData.nombreAfinidad != null && affiliationCard.titularData.nombreAfinidad.id != null) ? Long.valueOf(affiliationCard.titularData.nombreAfinidad.id.trim()) : JSONObject.NULL);
        ...
        if (obj instanceof JSONObject) {
            ...
            if (dic != null) {
                try {
                    ...
                    // Miembros con documento , un titular y una capita
                    //{"des_id":141,"ficha_id":230,"personas":[{"ficha_persona_id":84,"numero_documento":25633007},{"ficha_persona_id":85,"numero_documento":234567890} ]


                    // Miembros sin documento  : un titular y una capita
                    //{"des_id":141,"ficha_id":230,"personas":[{"ficha_persona_id":84,"numero_documento":25633007},{"ficha_persona_id":85,"numero_documento":null} ]
