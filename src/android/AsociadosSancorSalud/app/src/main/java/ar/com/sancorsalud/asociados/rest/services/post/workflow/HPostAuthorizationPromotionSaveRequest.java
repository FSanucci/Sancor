...
public class HPostAuthorizationPromotionSaveRequest extends HRequest<Void> {

    private static final String TAG = "HPOST_SAVE_AUTH_PROM";
    private static final String PATH = RestConstants.HOST + RestConstants.SAVE_AUTHORIZATION_PROMOTION;

    private AuthorizationPromotion mAuthorization;

    public HPostAuthorizationPromotionSaveRequest(AuthorizationPromotion authorization, Response.Listener<Void> listener, Response.ErrorListener errorListener) {
