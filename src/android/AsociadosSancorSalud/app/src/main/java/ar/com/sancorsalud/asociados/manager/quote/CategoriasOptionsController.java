...
public class CategoriasOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseCategorias(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetCategoriasRequest(listener,errorListener);
    }
