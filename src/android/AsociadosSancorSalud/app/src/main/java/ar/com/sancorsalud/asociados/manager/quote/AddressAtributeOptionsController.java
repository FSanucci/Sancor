...
public class AddressAtributeOptionsController extends BaseQuoteOptionsController<QuoteOption> {

    public String getObjectKey(){
        return "atributos_domicilio";
    }

    public String getLastUpdateKey(){
        return "atributos_domicilio_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseAddressAttributes(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetAddressAtributeRequest(listener,errorListener);
    }
