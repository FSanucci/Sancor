...
public class CivilStatusOptionsController extends BaseQuoteOptionsController<QuoteOption> {

    public String getObjectKey(){
        return "estados_civiles";
    }

    public String getLastUpdateKey(){return "estados_civiles_last_update";}
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseCivilStatus(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetCivilStatusRequest(listener,errorListener);
    }
