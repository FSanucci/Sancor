...
public class DocTypeOptionsController extends BaseQuoteOptionsController<QuoteOption> {
    ...
    public String getLastUpdateKey(){
        return "tipos_documentos_last_update";
    }
    ...
    public ArrayList<QuoteOption> parseData(String json){
        try {
            ...
            return ParserUtils.parseDocTypes(jsonObj);
    ...
    public HRequest createService(Response.Listener<ArrayList<QuoteOption>> listener, Response.ErrorListener errorListener){
        return RestApiServices.createGetDocTypesRequest(listener,errorListener);
    }
