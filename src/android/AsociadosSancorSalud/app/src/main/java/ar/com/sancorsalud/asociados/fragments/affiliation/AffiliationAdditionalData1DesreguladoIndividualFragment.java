...
public class AffiliationAdditionalData1DesreguladoIndividualFragment extends AffiliationAdditionalData1FormaPagoIndividualFragment {

    private static final String TAG = "AF_DESR_INDV1_FRG";
    ...
    public static AffiliationAdditionalData1DesreguladoIndividualFragment newInstance(AdditionalData1DesreguladoIndividual param1, long dni, long cardId, String cuil, String fechaInicioServicio) {
        AffiliationAdditionalData1DesreguladoIndividualFragment fragment = new AffiliationAdditionalData1DesreguladoIndividualFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            additionalData1 = (AdditionalData1DesreguladoIndividual) getArguments().getSerializable(ARG_ADD_DATA_1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainContainer = inflater.inflate(R.layout.fragment_affiliation_additional_data_desreg_ind1, container, false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == ConstantsUtil.VIEW_EE) {
            ...
            mEEAdapter.onRefresh(mEEAdapter.getEntidadEmpledoraList());
        }else {
    ...
    public IAdditionalData1 getAdditionalData1() {
        ...
        AdditionalData1DesreguladoIndividual additionalData = (AdditionalData1DesreguladoIndividual) super.getAdditionalData1();
    ...
    protected void initializeForm() {
        ...
        AdditionalData1DesreguladoIndividual additionalData = (AdditionalData1DesreguladoIndividual)additionalData1;
    ...
    protected void setupListeners() {
        ...
        mEEAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                ...
                IntentHelper.gotoEntidadEmpleadoraActivity(AffiliationAdditionalData1DesreguladoIndividualFragment.this, titularDNI, position, ee);
            }
        });
